CREATE TABLE IF NOT EXISTS oms_mq_consume_message (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY uk_order_mq_consume_key (consumer_group, message_key),
  KEY idx_order_mq_consume_status (status, update_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='order mq consume idempotent record';

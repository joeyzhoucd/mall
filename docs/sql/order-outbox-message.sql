CREATE TABLE IF NOT EXISTS oms_order_outbox_message (
  ...
  business_key varchar(128) NOT NULL COMMENT 'business key, usually order_sn',
  ...
  PRIMARY KEY (id),
  UNIQUE KEY uk_order_outbox_message_key (message_key),
  KEY idx_order_outbox_ready (status, next_retry_time, retry_count),
  KEY idx_order_outbox_business (business_type, business_key)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='order transactional outbox message';
